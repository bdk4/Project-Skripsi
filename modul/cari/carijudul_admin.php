...
echo"<form action='' method='POST'>
	...
	<td><input type='submit' value='Cari' name='submit' class='cari'></td>
	</tr>
	</table>";
...
<tr>
	...
	<td>$b[perihal]</td>
  <td>
	<span><a class='tombol kontrol hvrwarna' href='?module=carijudul_admin&act=lihat&id=$b[nosurat]'>Lihat</a></span><br>
	<span><a class='tombol kontrol hvrwarna' href='?module=carijudul_admin&act=edit&id=$b[nosurat]'>Edit</a></span><br>
	<span><a class='tombol kontrol hvrwarna'href=\"$aksi?module=carijudul_admin&act=hapus&id=$b[nosurat]\" onClick=\"return confirm('Yakin mau menghapusnya?')\">Hapus</a></span><br>
	</td>
	</tr>";
	$no++;
}} echo"</table></form>";
...
echo "<h1 class='head'>Edit Data Arsip</h1>
	<form action='$aksi?module=carijudul_admin&act=edit' method='post'>
	<table class='tabelform'>
	<tr>
...
<input type=button class=tombol value=Kembali onclick=window.location.href='media.php?module=carijudul_admin'></br>
	</br>
</br>
